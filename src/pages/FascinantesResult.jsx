                        ...
                        if (radarSection) {
                            ...
                            if (radarContainer) {
                                ...
                                if (wrapper && svg) {
                                    ...
                                    wrapper.style.setProperty('transform', 'translateX(-30px)', 'important');
                                    ...
                                    svg.style.setProperty('transform', 'translateX(-30px)', 'important'); // Backup transform for html2canvas
                                }
                            }
                        }
