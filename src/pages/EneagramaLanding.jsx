            ...
            <footer style={{ 
                ...
                <div className="el-section-content">
                    ...
                    <div style={{ 
                        ...
                        <a href="https://www.autenticos.co/" target="_blank" rel="noopener noreferrer" style={{ color: '#ddbe3d' }} className="el-social-icon"><Globe size={24} /></a>
                        <a href="https://www.instagram.com/autenticos.co/" target="_blank" rel="noopener noreferrer" style={{ color: '#ddbe3d' }} className="el-social-icon"><Instagram size={24} /></a>
                        <a href="https://www.facebook.com/clubautenticos" target="_blank" rel="noopener noreferrer" style={{ color: '#ddbe3d' }} className="el-social-icon"><Facebook size={24} /></a>
                        <a href="https://www.youtube.com/@AutenticosTV" target="_blank" rel="noopener noreferrer" style={{ color: '#ddbe3d' }} className="el-social-icon"><Youtube size={24} /></a>
                        <a href="https://www.linkedin.com/company/autenticos/?viewAsMember=true" target="_blank" rel="noopener noreferrer" style={{ color: '#ddbe3d' }} className="el-social-icon"><Linkedin size={24} /></a>
                    </div>
