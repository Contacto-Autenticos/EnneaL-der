                        ...
                        if (radarSection) {
                            ...
                            if (radarContainer) {
                                ...
                                if (wrapper && svg) {
                                    ...
                                    wrapper.style.setProperty('transform', 'translateX(-45px)', 'important');
                                    ...
                                    svg.style.setProperty('transform', 'translateX(-45px)', 'important'); // Backup transform for html2canvas
                                }
                            }
                        }
