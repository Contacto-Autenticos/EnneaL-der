                        ...
                        if (radarSection) {
                            ...
                            if (radarContainer) {
                                ...
                                if (wrapper && svg) {
                                    ...
                                    wrapper.style.setProperty('transform', 'translate(-15px, -10px)', 'important');
                                    ...
                                    svg.style.setProperty('transform', 'translate(-15px, -10px)', 'important'); // Backup transform for html2canvas
                                }
                            }
                        }
